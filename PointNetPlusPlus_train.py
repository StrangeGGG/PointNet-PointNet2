...
def train(model, train_loader, val_loader=None, epochs=10):
    ...
    # save the model
    torch.save(model.state_dict(), "save2_10_update2_noSA2.pth")
    ...
    # Save the plot
    plt.savefig('PointNetPlusPlus_10_loss_update2_noSA2.png')
    plt.close()
...
'''
learning rate = 0.0008, validation accuracy = 60%
10: val: 84
'''