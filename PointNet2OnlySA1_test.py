...
if os.path.exists('onlysa1_model.pth'):
    pointnet2.load_state_dict(torch.load('onlysa1_model.pth'))
    print('Loaded Only SA1 Model!')
...
plt.savefig('confusion_matrix_onlysa1.png', bbox_inches='tight', dpi=300)
plt.close()
...
df.to_csv('classification_report_onlysa1.csv', index_label='class')