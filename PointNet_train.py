...
def train(model, train_loader, val_loader=None, epochs=10):
    ...
    # save the model
    torch.save(model.state_dict(), "save_10.pth")
    ...
    # Save the plot
    plt.savefig('PointNet_10_loss.png')
    plt.close()
    ...
    #
    # # Save the plot
    # plt.savefig('PointNet_training_loss.png')
    # plt.close()
    #
    # plt.figure(figsize=(10, 5))
    ...
    #
    # # Save the plot
    # plt.savefig('PointNet_validation_loss.png')
    # plt.close()
